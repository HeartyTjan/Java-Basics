...
public class Kata1{
	...
	public static int calculateEvenNumber(int number){
		...
		else System.out.printf("Is %d an even number ? : false", number);
	...
	public static int divisionCalculation(int numerator, int divider){
	
		int divisionValue = numerator / divider;
	...
	public static void displayCalculationMenu(){
		...
		switch(option) {
			...
			case 4 :   System.out.print("""
				  ...
				  int numerator = receiver.nextInt();
				  System.out.print("Enter Second number : ");
				  int divider = receiver.nextInt();
				  System.out.print("The result is : " + divisionCalculation(numerator, divider));
				   displayCalculationMenu();break;
			...
			case 5 :  System.out.print("""
				  ...
				  userInput = receiver.nextInt();
				 System.out.print("The result is : " + calculateFactorOfNumber(userInput));
				  displayCalculationMenu();break;
			...
			case 8 :   System.out.print("""
				   ...
				   userInput = receiver.nextInt();
				   System.out.print("The result is : " + calculateFactorialOfNumber(userInput));
				    displayCalculationMenu();break;
			...
			case 9 :  System.out.print("""
				   ...
				   userInput = receiver.nextInt();
				  System.out.print("The result is : " + calculateSquareOfNumber(userInput)); 
				  displayCalculationMenu();break;
